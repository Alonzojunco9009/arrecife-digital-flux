...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden sand-texture py-20 px-6">
      {/* Animated gradient background */}
      <div className="absolute inset-0 bg-gradient-to-br from-background via-blue-50/20 to-teal-50/30 animate-[gradient_8s_ease-in-out_infinite]" style={{
      ...
      <div className="container mx-auto max-w-7xl flex flex-col justify-center items-center gap-8 relative z-10">
        ...
        ease: "easeOut"
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light text-foreground leading-tight" style={{
