...
const ServicesSection = () => {
  return (
    <section className="relative py-20 md:py-32 bg-gradient-to-b from-blue-50 to-blue-100 overflow-hidden">
      {/* Section Header */}
      <motion.div
      ...
      <div className="container mx-auto max-w-4xl px-6 space-y-12 md:space-y-20">
        {services.map((service, index) => {
          ...
          return (
            ...
            >
              <h3
                className={`text-4xl md:text-6xl lg:text-8xl font-light ${textColor} text-center leading-tight tracking-wide transition-all duration-300`}
                style={{
                  textShadow: isEven 
